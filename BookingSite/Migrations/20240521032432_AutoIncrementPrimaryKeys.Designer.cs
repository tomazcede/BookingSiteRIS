...
namespace BookingSite.Migrations
{
    ...
    [Migration("20240521032432_AutoIncrementPrimaryKeys")]
    partial class AutoIncrementPrimaryKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingSite.Model.Uporabniki", b =>
                {
                    ...
                    b.HasIndex(new[] { "TipUporabnikaId" }, "tip_uporabnika_id");

                    b.ToTable("uporabniki", "bookingdatabase");
                });
